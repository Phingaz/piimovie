  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: 'flex',
        head_cell: 'text-gray-300 rounded-md w-8 font-normal text-[0.8rem]',
        row: 'flex w-full mt-2',
        cell: cn(
          'relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-gray-300 [&:has([aria-selected].day-outside)]:bg-gray-300/50 [&:has([aria-selected].day-range-end)]:rounded-r-md',
          props.mode === 'range'
        ...
        day: cn(
          ...
          'h-8 w-8 p-0 font-normal aria-selected:bg-red-900 aria-selected:text-white',
        ),
